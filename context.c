...
//    This file is part of HighFCM, contact: pratas@ua.pt | ap@ua.pt         -
...
void UpdateHashCounter(CModel *cModel, uint64_t pModelIdx, uint8_t symbol)
  ...
  ++cModel->hTable.entries[hIndex][n].counters[symbol]; //changed to pre-increment
  }
